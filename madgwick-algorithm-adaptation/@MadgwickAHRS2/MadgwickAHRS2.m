...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    methods (Access = public)
        function obj = MadgwickAHRS2(varargin)
            for i = 1:2:nargin
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            qDot_w = 0.5 * quaternProd(q, [0 Gyroscope(1) Gyroscope(2) Gyroscope(3)]);

            % quaternion using w (gyro)
            q_w = q + qDot_w * obj.SamplePeriod;
            
            % quaternion based on previous quaternion and gradient descent
            q_d = q - obj.Beta * step';
            
            % fusing
            q = obj.Gamma * q_d + (1-obj.Gamma) * q_w;
