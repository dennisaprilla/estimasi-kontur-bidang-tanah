...
step1_y = 0:density:60;
step1_z = zeros(1, length(step1_y));
step1_x = zeros(1, length(step1_y));

step2_y = 60:density:60+62.2;
%step2_z = linspace(0, 11.5, length(step2_y));
step2_z = linspace(0, 10.5, length(step2_y));
step2_x = zeros(1, length(step2_y));

step3_y = 60+62.2:density:60+62.2+90;
%step3_z = ones(1, length(step3_y))*11.5;
step3_z = ones(1, length(step3_y))*10.5;
step3_x = zeros(1, length(step3_y));
...
save('groundtruth_1.mat', 'coords', 'coords_smooth', 'coords_surfacexyz', 'coords_koordinatroll', 'coords_nilairoll');
